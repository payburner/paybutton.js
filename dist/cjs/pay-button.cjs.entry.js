...
const PayButton = class {
    ...
    renderModal(showGetPayburner, showNotLoggedIn) {
        if (this.purchase.status === 'SETTLED') {
            return index.h("div", { id: "myModal", class: this.modalStatus === 'hide' ? 'modal hidden' : 'modal shown' }, index.h("div", { class: "modal-content" }, index.h("span", { class: "close", onClick: () => this.closeModal() }, "\u00D7"), index.h("p", { class: "xrp-price", onClick: () => copyTextToClipboard_1(this.purchase.expectedAmount.toString()) }, this.purchase.expectedAmount, " XRP"), index.h("p", { class: "payburner-blurb" }, "To pay, send XRP to the following address and tag using any XRP wallet."), index.h("p", { class: "label" }, "XRP Address"), index.h("p", { class: "xrp-address", onClick: () => copyTextToClipboard_1(this.purchase.expectedDestinationXrpAddress) }, this.purchase.expectedDestinationXrpAddress, " ", this.renderCopyIcon()), index.h("p", { class: "label" }, "Tag"), index.h("p", { class: "xrp-address-tag", onClick: () => copyTextToClipboard_1(this.purchase.expectedDestinationXrpAddressTag) }, this.purchase.expectedDestinationXrpAddressTag, " ", this.renderCopyIcon()), index.h("hr", null), index.h("p", { class: "waiting" }, "Thank you for your payment!  Your payment id is ", this.purchase.purchaseId), index.h("hr", null), showGetPayburner ? (index.h("p", { class: "payburner-blurb" }, "If you don't have an XRP wallet or want a great payment experience, click here to install the ", index.h("a", { href: "https://chrome.google.com/webstore/detail/ghigcfhmoaokccllienfhdhdndkfhmop/publish-accepted?authuser=3&hl=en" }, "Payburner Wallet"), ".")) : null, showNotLoggedIn ? (index.h("p", { class: "payburner-blurb" }, "Your Paybuner Wallet is not logged in.")) : null));
        }
        else {
            return index.h("div", { id: "myModal", class: this.modalStatus === 'hide' ? 'modal hidden' : 'modal shown' }, index.h("div", { class: "modal-content" }, index.h("span", { class: "close", onClick: () => this.closeModal() }, "\u00D7"), index.h("p", { class: "xrp-price", onClick: () => copyTextToClipboard_1(this.purchase.expectedAmount.toString()) }, this.purchase.expectedAmount, " XRP"), index.h("p", { class: "payburner-blurb" }, "To pay, send XRP to the following address and tag using any XRP wallet."), index.h("p", { class: "label" }, "XRP Address"), index.h("p", { class: "xrp-address", onClick: () => copyTextToClipboard_1(this.purchase.expectedDestinationXrpAddress) }, this.purchase.expectedDestinationXrpAddress, " ", this.renderCopyIcon()), index.h("p", { class: "label" }, "Tag"), index.h("p", { class: "xrp-address-tag", onClick: () => copyTextToClipboard_1(this.purchase.expectedDestinationXrpAddressTag) }, this.purchase.expectedDestinationXrpAddressTag, " ", this.renderCopyIcon()), index.h("hr", null), index.h("p", { class: "waiting" }, "Waiting for you to send XRP to the address and tag."), index.h("div", { class: "lds-ellipsis" }, index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null)), index.h("hr", null), showGetPayburner ? (index.h("p", { class: "payburner-blurb" }, "If you don't have an XRP wallet or want a great payment experience, click here to install the ", index.h("a", { href: "https://chrome.google.com/webstore/detail/ghigcfhmoaokccllienfhdhdndkfhmop/publish-accepted?authuser=3&hl=en" }, "Payburner Wallet"), ".")) : null, showNotLoggedIn ? (index.h("p", { class: "payburner-blurb" }, "Your Paybuner Wallet is not logged in.")) : null));
        }
    }
    render() {
        const PAYBURNER = window.PAYBURNER;
        if (typeof PAYBURNER === 'undefined') {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("div", null, index.h("button", { onClick: () => this.openModal(), class: "pure-material-button-contained" }, this.buttonStatus === 'LOADED' ? (this.calcedPrice + ' XRP') : (this.buttonStatus)), this.renderModal(false, false)));
        }
        else if (!this.isPayburnerConnected()) {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("div", null, index.h("button", { class: "pure-material-button-contained", onClick: () => this.openModal() }, this.buttonStatus === 'LOADED' ? (this.calcedPrice + ' XRP') : (this.buttonStatus)), this.renderModal(true, false)));
        }
        else if (!this.isPayburnerLoggedIn()) {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("div", null, index.h("button", { class: "pure-material-button-contained", onClick: () => this.openModal() }, this.buttonStatus === 'LOADED' ? (this.calcedPrice + ' XRP') : (this.buttonStatus)), this.renderModal(false, true)));
        }
        else if (this.buttonStatus === 'PENDING') {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("button", { class: "pure-material-button-contained" }, this.buttonStatus));
        }
        else if (this.buttonStatus === 'ERROR') {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("button", { onClick: () => this.handleReset(), class: "pure-material-button-contained" }, "ERROR"));
        }
        else if (this.buttonStatus === 'WAITING') {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("button", { onClick: () => this.handleReset(), class: "pure-material-button-contained" }, "WAITING"));
        }
        else if (this.buttonStatus === 'TIMEOUT') {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("button", { onClick: () => this.handleReset(), class: "pure-material-button-contained" }, "TIMEOUT"));
        }
        else if (this.buttonStatus === 'SETTLING') {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("button", { onClick: () => this.handleReset(), class: "pure-material-button-contained" }, this.buttonStatus));
        }
        else if (this.buttonStatus === 'SETTLED') {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("button", { onClick: () => this.handleReset(), class: "pure-material-button-contained" }, this.buttonStatus));
        }
        else if (this.buttonStatus === 'LOADED') {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("button", { onClick: () => this.handleClick(), class: "pure-material-button-contained" }, this.calcedPrice, " XRP"));
        }
        else {
            return index.h(index.Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, index.h("button", { onClick: () => this.handleClick(), class: "pure-material-button-contained" }, "UNKNOWN: ", this.buttonStatus));
        }
    }
