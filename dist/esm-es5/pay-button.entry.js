...
var PayButton = /** @class */ (function () {
    ...
    class_1.prototype.renderModal = function (showGetPayburner) {
        var _this = this;
        var isConnected = this.isPayburnerConnected();
        var isLoggedIn = this.isPayburnerLoggedIn();
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return h(Host, { purchaseId: this.purchase.purchaseId, status: this.buttonStatus }, h("div", null, h("button", { onClick: function () { return _this.openModal(); }, class: "pure-material-button-contained" }, this.buttonStatus === 'LOADED' ? (this.calcedPrice + ' XRP') : (this.buttonStatus)), this.renderModal(false)));
    };
